...
Firmware používá společný **Virtual Sensors Communication Protocol** API `1.6`
...
- `vscp_types.hpp` definuje API `1.6`, příkazy, stav a datové struktury.
